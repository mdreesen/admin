...
export default function Customers() {
  return (
    <ul role="list" className="grid grid-cols-1 h-[56vh] overflow-auto">
      {people.map((person, index) => (
        <li key={`${person.email}-${index}`} className="col-span-1 divide-y divide-gray-200 rounded-lg bg-white shadow">
