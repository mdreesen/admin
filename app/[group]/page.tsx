...
export default function Page() {
    ...
    const bottomSecond = (
        <div className="relative lg:col-span-2">
            <h2 className="text-base/7 font-semibold text-indigo-600">Expenses</h2>
            <UseDonutChart />
        </div>
    );
    ...
    const bottomThird = (
        <div className="relative lg:col-span-2">
            <h2 className="text-base/7 font-semibold text-indigo-600">Revenue</h2>
            <UseRevenueBarChart />
        </div>
    );
    ...
    return (
        <div className="bg-white py-24 sm:py-32">
            <div className="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8">
                <h2 className="text-base/7 font-semibold text-indigo-600">Company</h2>
